    ...
    functionalTestBucketProvider: FunctionalTestBucketProvider,
        ...
        params {
            if (model.branch.isMaster || model.branch.isExperimental) {
                param("env.GRADLE_OPTS", "-Dorg.gradle.unsafe.isolated-projects=%enableIsolatedProjectsExperiment%")
            }
            ...
            text(
                ...
                allowEmpty = true,
                description =
                    "The extra gradle parameters you want to pass to all dependencies of this build, " +
        ...
        model.stages.forEach { stage ->
            ...
            val stageProject =
                StageProject(
                    ...
                    stage,
                    previousPerformanceTestPasses,
                    previousCrossVersionTests,
                )
